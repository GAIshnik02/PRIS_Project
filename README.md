...
| Роль | Имя |
|------|------|
| Product Owner | [ФИО студента 1] |
| Data Scientist / ML Engineer | [ФИО студента 2] |
| Data Architect / Software Architect | [ФИО студента 3] |

> *Роли могут совмещаться при численности команды 2 человека.*
...
| Диаграмма | Формат | Файл |
|-----------|--------|------|
| Бизнес-процесс «как есть» (ручной КПП) | BPMN | `/diagrams/bpmn_as_is.png` |
| Бизнес-процесс «как будет» (ML-КПП) | BPMN | `/diagrams/bpmn_to_be.png` |
| ER-диаграмма базы сотрудников и логов | ER | `/diagrams/er_diagram.md` |
| Архитектура системы (распределённое хранение эмбеддингов) | C4 | `/diagrams/system_architecture.md` |
| UML-диаграмма компонентов | UML | `/diagrams/uml_components.md` |
| UML-диаграмма активностей (сценарий прохода) | UML | `/diagrams/uml_activity.md` |
